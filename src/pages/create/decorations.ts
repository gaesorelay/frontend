...
// 메인페이지 장식 (bone과 foot만)
export const mainDecorations: DecoProps[] = [
  { src: bone, x: 8, y: 18, size: 70, rotate: 45, duration: 3.5 },
  { src: foot, x: 15, y: 35, size: 50, rotate: -10, duration: 4 },
  { src: bone, x: 5, y: 58, size: 60, rotate: -30 },
  { src: bone, x: 40, y: 58, size: 60, rotate: -30 },
  { src: bone, x: 45, y: 80, size: 60, rotate: -30 },
  { src: bone, x: 65, y: 80, size: 60, rotate: -30 },
  ...
  { src: bone, right: 4, y: 50, size: 55, rotate: 10 },
  { src: bone, right: 15, bottom: 22, size: 70, delay: 0.4 },
  { src: foot, right: 10, bottom: 5, size: 50, rotate: -15, duration: 3.2 },
  { src: foot, right: 10, y: 15, size: 50, rotate: -15, duration: 3.2 },
  { src: foot, x: 10, bottom: 5, size: 55, rotate: 20, duration: 3 },
  { src: foot, x: 30, bottom: 5, size: 55, rotate: 20, duration: 3 },
  { src: foot, x: 50, bottom: 10, size: 55, rotate: 20, duration: 3 },
];
